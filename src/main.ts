...
class FindAndReplaceModal extends Modal {
    ...
    onOpen() {
        ...
        // Create additional settings toggle switches
        const caseInsensitiveToggleComponent = addToggleComponent(this.language.caseInsensitiveName, this.language.caseInsensitiveDesc);
        const processLineBreakToggleComponent = addToggleComponent(this.language.processLineBreakName, this.language.processLineBreakDesc);
        const processTabToggleComponent = addToggleComponent(this.language.processTabName, this.language.processTabDesc);
        const prefillFindToggleComponent = addToggleComponent(this.language.prefillFindName, this.language.prefillFindDesc);
        ...
        // Update regex-flags when caseInsensitive changes
        ...
        // Update postfix label when processLineBreak changes
